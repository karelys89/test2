...
//Question 2.3
//What is the value of x?   "50thug life"
...
var city = "Miami"
firstName+" "+lastName+" vive en "+ city

//Question 3.2
//Write a sentence that uses the following variables
totalPower = 32
generator = 1
+generator+" generador tiene un total de power de "+totalPower
...
//que bola acere is similar to sup dawg in spanish
...
if(currentPool<=7){
totalVolume += 1000
console.log("la piscins #"+currentPool +" esta llena para un total de "+totalVolume +" galones")
